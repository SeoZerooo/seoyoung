...
var code = "";
	...
	var usPhoneNum = $("#usPhoneNum").val();
	$.ajax({
        type:"GET",
        url:"findid?usEmail=" + usEmail+"&usName="+usName+"&usPhoneNum="+usPhoneNum,
        cache : false,
	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4 w3-auto" style="width: 382px;height: 456.3px;">
			...
			<div>
				<p>
					<label>닉네임</label>
					<input class="w3-input" type="text" id="usName" name="usName" placeholder="회원가입한 닉네임을 입력하세요" required>
				</p>
				<p>
					<label>핸드폰 번호</label>
					<input class="w3-input" type="text" id="usPhoneNum" name="usPhoneNum" placeholder="회원가입한 전화 번호를 입력하세요" required>
				</p>
				<p>
					<label>이메일</label>
				...
				<p class="w3-center">
					<button type="button" id="findBtn" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">아이디 찾기</button>
