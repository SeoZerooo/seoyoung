	...
	<main>
		<div id="container" class="container-xxl ">
			<div class="d-flex align-items-end">
				<h1>공지사항 작성</h1>
				<span class="text-muted flex-grow-1" style="margin-left: 10px;"> - 공지사항 작성</span>
			</div>
			<hr>
<!-- 글쓰기 폼 -->
			<form class="w-75 mx-auto" action="/hallo03talk/comm/notice/post" method="post">
				...
				<input type="hidden" name="writer" value="0">
