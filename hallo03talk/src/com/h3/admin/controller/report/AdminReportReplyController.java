...
public class AdminReportReplyController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//listCount 값 구하기
		listCount = new AdminReportService().getCountReply();//DB에 가서, board 테이블의 총 게시글 갯수
...
//		startPage : 21 = > 30
		...
		ArrayList<ReportCommentVo> voList  =new AdminReportService().selectListComment(pageVo);
